...
export const translations: Record<Language, any> = {
  ...
  lt: {
    ...
    programs: {
      ...
      virtualClass: "Jaunieji atradėjai",
      virtualClassDesc: "Spausk, žaisk, klausk, atrask. Mokymasis tampa magija.",
      studentMonitoring: "Kūrybingi statytojai",
  ...
  ru: {
    ...
    hero: {
      ...
      description: "Чтобы подать заявку на нашу партнерскую программу, начните с бесплатной регистрации в Refersion. Refersion всё настроит!",
      emailPlaceholder: "Введите ваш email",
      ctaButton: "Получить 7-дневный пробный период",
      ready: "ГОТОВО! 🚀",
    ...
    programs: {
      title: "НАШИ СПЕЦИАЛЬНЫЕ ПРОГРАММЫ",
      subtitle: "ДЛЯ ВАШЕГО",
    ...
    heroStats: {
      freeLessons: "500+ Бесплатных уроков для студентов",
      activeStudents: "100k Активных студентов на наших курсах",
      worldwideStudents: "20k+ Студентов по всему миру",
    },
    header: {
    ...
    footer: {
      ...
      callNewmindr: "Позвоните newmindr",
      letsWorkTogether: "Давайте работать вместе",
      coursesTools: "Курсы и инструменты",
      creativeTools: "Творческие инструменты",
      newsletter: "Рассылка",
      newsletterDescription: "Подпишитесь на нашу рассылку, чтобы получать последние обновления и образовательные ресурсы.",
    ...
    about: {
      ...
      achievementDesc: "Отмечаем каждую веху и успех, каким бы маленьким он ни был, на пути к обучению.",
      creativity: "Творчество",
      creativityDesc: "Поощряем творческое мышление и инновационные подходы к решению проблем и обучению.",
      growth: "Рост",
      growthDesc: "Расширяем возможности учащихся достигать новых высот и раскрывать свой полный потенциал.",
      description1: "Мы стремимся революционизировать образование и сделать обучение доступным, увлекательным и преобразующим для всех, везде.",
      description2: "В newmindr мы верим, что образование должно быть путешествием открытий, а не пунктом назначения. Наша платформа сочетает инновационные технологии с проверенными педагогическими методами для создания образовательных программ, которые действительно раскрывают потенциал.",
      activeStudents: "Активные студенты",
      freeLessons: "Бесплатные уроки",
      worldwideStudents: "Студенты по всему миру",
      cta: "Start Your Journey",
      services: {
        education: "Education",
        learning: "Learning",
      ...
      popups: {
        ...
        more: {
          ...
          founded: "Основанная в 2022 году, мы создаем платформу для обучения следующего поколения.",
          includes: "Также включает:",
          missionValues: "Наша миссия и ценности",
          whoItsFor: "Для кого это",
          designPhil: "Философия дизайна",
          location: "Местоположение",
          missionValuesTitle: "Миссия и ценности",
          ourMissionLabel: "Наша миссия",
          missionShortDesc: "Мы здесь, чтобы сделать обучение активным, вовлекающим и доступным.",
          designPhilosophyDesc: "Мы верим, что экранное время может быть активным, а не пассивным.",
          designPhil1: "Первым делом взаимодействие",
    ...
    contact: {
      ...
      chatDescription: "Наша дружелюбная команда здесь, чтобы помочь.",
      ...
      headline: "Есть идеи? У нас есть навыки. Давайте работать вместе.",
      subheadline: "Расскажите нам больше о себе и о том, что у вас на уме.",
      fullName: "Полное имя",
      ...
      messagePlaceholder: "Расскажите немного о проекте...",
      ...
      strategyConsulting: "ПЛАТЕЖИ И СЧЕТА",
      other: "ОБЩИЙ ВОПРОС",
    ...
    studyingProcess: {
      ...
      completed: "Завершено",
      journeyUnlocked: "Путешествие разблокировано!",
      experienceReal: "You understand the process. Now experience it for real.",
      startFirstClass: "Start Your First Class",
      modal: {
        readyToStart: "Ready to Start?",
    ...
    infoModal: {
      ...
      about: {
        ...
        intro: "В newmindr мы верим, что традиционная система образования не успевает за темпами технологий. Мы здесь, чтобы преодолеть этот разрыв.",
        missionTitle: "Наша миссия",
        missionDesc: "Дать студентам практические, ориентированные на будущее навыки через захватывающее обучение и творчество.",
        methodTitle: "Наш метод",
        methodDesc: "Проектное обучение, атмосфера без давления и наставничество отраслевых экспертов.",
        footer: "Присоединяйтесь к более чем 1000 студентам по всему миру, которые уже сегодня строят свое будущее."
      },
      programs: {
        title: "Наши программы",
        subtitle: "Специально для каждой возрастной группы",
        youngExplorers: "Юные исследователи (8-12)",
        youngExplorersDesc: "Геймифицированное обучение с упором на логику, сторителлинг и базовую техническую грамотность.",
        teenInnovators: "Подростки-инноваторы (13-16)",
        teenInnovatorsDesc: "Практические семинары по дизайну, программированию и совместным проектам.",
        futureLeaders: "Будущие лидеры (17-19)",
        futureLeadersDesc: "Продвинутые курсы по ИИ, автоматизации, лидерству и созданию стартапов."
      },
      pricing: {
        title: "Тарифные планы",
        subtitle: "Прозрачно и гибко для каждого",
        monthly: "Ежемесячно",
        yearly: "Ежегодно",
        save: "Экономия 20%",
        basic: {
          title: "Базовый план",
          desc: "Полный доступ к интерактивной библиотеке и самостоятельным курсам.",
          feature1: "Бесконечные игры",
          feature2: "Мировое сообщество"
        },
        pro: {
          title: "Профессиональный",
          desc: "Ежедневные живые семинары с преданными отраслевыми инструкторами.",
          feature1: "Наставничество 1 на 1",
          feature2: "Создание портфолио",
          badge: "Лучший выбор"
        }
      },
      contact: {
        title: "Свяжитесь с нами",
        subtitle: "Мы здесь, чтобы помочь вам расти",
        directContact: "Прямой контакт",
        ourStudio: "Наша студия",
        visitSocial: "Посетите наши соцсети",
        socialDesc: "Следите за нами для ежедневных советов и успехов студентов!",
    ...
    legal: {
      privacy: {
        ...
        footer: "© 2025 newmindr. All rights reserved."
      },
      terms: {
    ...
    devPopup: {
      badge: "Скоро",
      title: "Мы Создаем Что-то Удивительное!",
      subtitle: "Будущее интерактивного обучения уже близко.",
      description: "Мы активно разрабатываем платформу и скоро запустимся! Зарезервируйте место сейчас и станьте одним из первых, кто испытает обучение нового поколения.",
      emailLabel: "Ваш Email",
      emailPlaceholder: "vy@example.com",
      ctaButton: "Зарезервировать Место",
      skipButton: "Вернусь позже",
      successTitle: "Вы Зарегистрированы!",
      successMessage: "Мы уведомим вас, как только запустимся. Готовьтесь! 🚀"
    },
    validation: {
