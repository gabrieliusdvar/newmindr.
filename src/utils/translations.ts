...
export const translations: Record<Language, any> = {
  ...
  ru: {
    ...
    features: {
      ...
      avatars: {
        creative: { name: "Творческий", desc: "Развивайте креатив и новаторское мышление" },
        logical: { name: "Логический", desc: "Укрепляйте логику и решение сложных задач" },
        social: { name: "Социальный", desc: "Улучшайте навыки общения и командной работы" },
        visual: { name: "Визуальный", desc: "Развивайте пространственное восприятие и вкус" }
      },
