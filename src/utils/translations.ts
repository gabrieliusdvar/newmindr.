  ...
  ru: {
    ...
    features: {
      ...
      minigames: {
        ...
        visual: {
          name: "Визуальное видение",
          task: "Построение пути",
          instruction: "Гипер-фокус: Оставайтесь на линиях. Соединяйте узлы по порядку, не сбиваясь с пути."
        }
      },
      avatars: {
        creative: { name: "Творческий", desc: "Исследуйте артистическое и инновационное мышление" },
        logical: { name: "Логический", desc: "Развивайте аналитические навыки и решение проблем" },
        social: { name: "Социальный", desc: "Развивайте навыки общения и командной работы" },
        visual: { name: "Визуальный", desc: "Улучшайте пространственное и визуальное восприятие" }
      },
      ...
      learningVirtuallyDesc: "Юные исследователи учатся через игры, живые занятия и задания. Они кликают, играют и открывают новое, активно участвуя.",
    ...
    infoModal: {
      ...
      about: {
        ...
        missionTitle: "Миссия",
        missionDesc: "Дать ученикам практические навыки через погружение в творчество.",
        methodTitle: "Метод",
    ...
    legal: {
      privacy: {
        ...
        intro: "В newmindr. мы стремимся защищать вашу частную жизнь и обеспечивать безопасность ваших персональных данных. Эта политика описывает, как мы собираем и используем вашу информацию.",
        sections: [
          {
            title: "1. Сбор информации",
            content: "Мы собираем типы данных, по которым можно установить вашу личность: имя, email, телефон и данные об использовании платформы.",
            list: [
              "Информация, предоставляемая вами (регистрация).",
              "Автоматический сбор (Usage data, куки).",
              "Сторонние источники (соцсети)."
            ]
          },
          {
            title: "2. Использование данных",
            content: "Мы используем ваши данные для предоставления услуг, улучшения платформы и связи с вами.",
            list: [
              "Улучшение образовательных услуг.",
              "Обработка транзакций.",
              "Персонализация обучения."
            ]
          }
        ],
        footer: "© 2025 newmindr. Все права защищены. Соответствие GDPR и международным стандартам."
      },
      terms: {
        title: "Условия использования",
        lastUpdated: "30 декабря 2025 г.",
        intro: "ПОЖАЛУЙСТА, ПРОЧТИТЕ ВНИМАТЕЛЬНО. ИСПОЛЬЗУЯ ПЛАТФОРМУ NEWMINDR., ВЫ СОГЛАШАЕТЕСЬ С ДАННЫМИ УСЛОВИЯМИ.",
        sections: [
          {
            title: "1. Принятие условий",
            content: "Используя newmindr., вы соглашаетесь с данными условиями. Если вы не согласны, пожалуйста, не используйте платформу."
          },
          {
            title: "2. Аккаунт",
            content: "Вы несете ответственность за безопасность своего пароля и точность предоставленных данных."
          }
        ],
        footer: "ИСПОЛЬЗУЯ ЭТУ ПЛАТФОРМУ, ВЫ ПОДТВЕРЖДАЕТЕ, ЧТО ПРОЧЛИ И СОГЛАСНЫ С УСЛОВИЯМИ."
      }
    },
    devPopup: {
      badge: "Скоро",
