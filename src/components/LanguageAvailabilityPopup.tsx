                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <button
                            ...
                            className="p-3 bg-white text-black border-2 border-white rounded-full hover:bg-gray-200 transition-all shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] active:translate-y-1 active:shadow-none"
                        >
                            <X className="w-6 h-6" />
                        </button>
                    </div>
